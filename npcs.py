...
class NPC(mixins.ReprMixin, mixins.DataFileMixin, threading.Thread):
    ...
    def view_description(self):
        if self.right_hand_inv:
            right_hand = "{} has {} in {} right hand.".format(self.first_name, self.right_hand_inv, self.object_pronoun.lower())
        else:
            right_hand = "{} right hand is empty.".format(self.possessive_pronoun)
        if self.left_hand_inv:
            left_hand = "{} has {} in {} left hand.".format(self.first_name, self.left_hand_inv, self.object_pronoun.lower())
        else:
        ...
        print(right_hand)
        print(left_hand)
        print(wrapper.fill(self.description))
